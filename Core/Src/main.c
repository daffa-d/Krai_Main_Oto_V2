...
const osThreadAttr_t myTask01_attributes = { .name = "myTask01", .stack_size =
		2048 * 4, .priority = (osPriority_t) osPriorityRealtime, };
/* Definitions for myTask02 */
osThreadId_t myTask02Handle;
const osThreadAttr_t myTask02_attributes = { .name = "myTask02", .stack_size =
		1024 * 4, .priority = (osPriority_t) osPriorityHigh2, };
/* Definitions for ImuTask */
osThreadId_t ImuTaskHandle;
const osThreadAttr_t ImuTask_attributes = { .name = "ImuTask", .stack_size = 128
		* 4, .priority = (osPriority_t) osPriorityHigh2, };
/* Definitions for myTask04 */
osThreadId_t myTask04Handle;
uint32_t myTask04Buffer[256];
osStaticThreadDef_t myTask04ControlBlock;
const osThreadAttr_t myTask04_attributes = { .name = "myTask04", .cb_mem =
		&myTask04ControlBlock, .cb_size = sizeof(myTask04ControlBlock),
		.stack_mem = &myTask04Buffer[0], .stack_size = sizeof(myTask04Buffer),
		.priority = (osPriority_t) osPriorityNormal, };
/* USER CODE BEGIN PV */
extern int16_t rawYaw; // data mentah heading
int16_t yawRef; // refrensi yaw / heading
int16_t valMotor[4];
int16_t valueENC_EXT[3];
